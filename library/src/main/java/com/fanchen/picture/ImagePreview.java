...
public class ImagePreview {
    ...
    private int closeIconResId = R.drawable.ic_pic_action_close;
    private int downIconResId = R.drawable.ic_pic_download_new;

    // 加载失败时的占位图
    private int errorPlaceHolder = R.drawable.ic_pic_load_failed;
