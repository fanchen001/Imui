...
//import com.fanchen.picture.glide.engine.ProgressTarget;
import com.fanchen.picture.tool.DownloadPictureUtil;
import com.fanchen.picture.tool.HandlerUtils;
...
public class ImagePreviewActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_indicator.setText(
                String.format(getString(R.string.pic_indicator), currentItem + 1 + "", "" + imageInfoList.size()));
