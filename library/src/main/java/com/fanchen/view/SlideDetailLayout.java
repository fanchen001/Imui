...
public class SlideDetailLayout extends ViewGroup {
    ...
    public SlideDetailLayout(Context context) {
        this(context, null);
    }

    public SlideDetailLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideDetailLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SlideGoodsLayout, defStyleAttr, 0);
        mPercent = a.getFloat(R.styleable.SlideGoodsLayout_default_panel, DEFAULT_PERCENT);
        mDuration = a.getInt(R.styleable.SlideGoodsLayout_durations, DEFAULT_DURATION);
        mDefaultPanel = a.getInt(R.styleable.SlideGoodsLayout_default_panel, 0);
        a.recycle();
