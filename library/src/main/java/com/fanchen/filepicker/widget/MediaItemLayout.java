...
// */
//
//package com.fanchen.filepicker.widget;
//
...
//import com.bilibili.pic_impl.BoxingResHelper;
//import com.bilibili.pic_impl.WindowManagerHelper;
//import com.fanchen.thinkfme.R;
//
//
///**
...
//        View view = LayoutInflater.from(context).inflate(R.layout.layout_pic_media_item, this, true);
...
//            width = (screenWidth - getResources().getDimensionPixelOffset(R.dimen.pic_media_margin) * 4) / 3;
//        }
...
//            return;
//        }
//        mCoverImg.setTag(R.string.pic_app_name, path);
