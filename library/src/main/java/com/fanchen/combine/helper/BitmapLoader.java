...
import com.fanchen.combine.cache.DiskLruCacheHelper;
import com.fanchen.combine.cache.LruCacheHelper;
...
public class BitmapLoader {
    ...
    private Bitmap loadBitmapFromDiskCache(String url, int reqWidth, int reqHeight) throws IOException {
        ...
        if (snapShot != null) {
            FileInputStream fileInputStream = new FileInputStream(snapShot.getFile(0));
    ...
    private boolean collectUndoTasks(String url, Runnable task) {
        ...
        DiskLruCache.Value snapShot = null;
        try {
