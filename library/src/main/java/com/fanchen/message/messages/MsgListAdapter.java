...
public class MsgListAdapter<MESSAGE extends IMessage> extends RecyclerView.Adapter<ViewHolder>
    ...
    private final int TYPE_SEND_FILE = 13;
    private final int TYPE_RECEIVER_FILE = 14;

    private final int TYPE_SEND_IDCARD = 15;
    private final int TYPE_RECEIVER_IDCARD = 16;

    private final int TYPE_SEND_GOODS = 17;
    private final int TYPE_RECEIVER_GOODS = 18;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case TYPE_RECEIVER_IDCARD:
                return getHolder(parent, mHolders.mReceiveIdcardLayout, mHolders.mReceiveIdcardHolder, false);
            case TYPE_SEND_GOODS:
                return getHolder(parent, mHolders.mSendGoodsLayout, mHolders.mSendGoodsHolder, true);
            case TYPE_RECEIVER_GOODS:
                return getHolder(parent, mHolders.mReceiveGoodsLayout, mHolders.mReceiveGoodsHolder, false);
            case TYPE_SEND_ORDER:
                return getHolder(parent, mHolders.mSendOrderLayout, mHolders.mSendOrderHolder, true);
            case TYPE_RECEIVER_ORDER:
    ...
    public int getItemViewType(int position) {
        ...
        if (wrapper.item instanceof IMessage) {
            ...
            } else if (message.getType() == IMessage.MessageType.RECEIVE_FILE.ordinal()) {
                return TYPE_RECEIVER_FILE;
            } else if (message.getType() == IMessage.MessageType.SEND_FILE.ordinal()) {
                return TYPE_SEND_FILE;
            } else if (message.getType() == IMessage.MessageType.RECEIVE_ID_CARD.ordinal()) {
                return TYPE_RECEIVER_IDCARD;
            } else if (message.getType() == IMessage.MessageType.SEND_ID_CARD.ordinal()) {
                return TYPE_SEND_IDCARD;
            } else if (message.getType() == IMessage.MessageType.RECEIVE_GOODS.ordinal()) {
    ...
    public interface OnMsgClickListener<MESSAGE extends IMessage> {
        ...
        void onMessageChildClick(View v,MESSAGE message);
    }
    ...
    public static class HoldersConfig {
        ...
        private Class<? extends BaseMessageViewHolder<? extends IMessage>> mSendIdcardHolder;
        private Class<? extends BaseMessageViewHolder<? extends IMessage>> mReceiveIdcardHolder;

        private Class<? extends BaseMessageViewHolder<? extends IMessage>> mSendGoodsHolder;
        private Class<? extends BaseMessageViewHolder<? extends IMessage>> mReceiveGoodsHolder;

        private Class<? extends BaseMessageViewHolder<? extends IMessage>> mSendOrderHolder;
        private Class<? extends BaseMessageViewHolder<? extends IMessage>> mReceiveOrderHolder;
        ...
        private int mSendIdcardLayout;
        private int mReceiveIdcardLayout;

        private int mSendGoodsLayout;
        private int mReceiveGoodsLayout;
        ...
        public HoldersConfig() {
            ...
            mReceiveIdcardHolder = DefaultIdCardViewHolder.class;
            mSendIdcardHolder = DefaultIdCardViewHolder.class;

            mReceiveOrderHolder = DefaultOrderViewHolder.class;
            mSendOrderHolder = DefaultOrderViewHolder.class;

            mReceiveGoodsHolder = DefaultGoodsViewHolder.class;
            ...
            mSendFileLayout = R.layout.item_send_msg_file;
            mReceiveFileLayout = R.layout.item_receive_msg_file;

            mSendLocationLayout = R.layout.item_send_msg_location;
            mReceiveLocationLayout = R.layout.item_receive_msg_location;
            ...
            mSendPhotoLayout = R.layout.item_send_msg_photo;
            mReceivePhotoLayout = R.layout.item_receive_msg_photo;

            mSendVideoLayout = R.layout.item_send_msg_video;
            mReceiveVideoLayout = R.layout.item_receive_msg_video;
    ...
    private static class DefaultIdCardViewHolder extends IdCardViewHolder<IMessage> {

        public DefaultIdCardViewHolder(View itemView, boolean isSender) {
            super(itemView, isSender);
        }

    }

    private static class DefaultGoodsViewHolder extends GoodsViewHolder<IMessage> {

        public DefaultGoodsViewHolder(View itemView, boolean isSender) {
            super(itemView, isSender);
        }
