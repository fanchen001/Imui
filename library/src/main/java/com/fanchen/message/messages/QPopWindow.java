 ...
 */
 public class QPopWindow extends PopupWindow {
    ...
    private static final int DEFAULT_TEXT_PADDING_LEFT = 18;
    private static final int DEFAULT_TEXT_PADDING_TOP = 7;
    private static final int DEFAULT_TEXT_PADDING_RIGHT = 18;
    private static final int DEFAULT_TEXT_PADDING_BOTTOM = 7;
    ...
    private static final int DEFAULT_BACKGROUND_RADIUS = 6;
