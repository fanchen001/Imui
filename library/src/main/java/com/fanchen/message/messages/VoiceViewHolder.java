...
public class VoiceViewHolder<MESSAGE extends IMessage> extends BaseMessageViewHolder<MESSAGE>
    ...
    public void applyStyle(MessageListStyle style) {
        ...
        if (mIsSender) {
            mVoiceIv.setImageResource(mSendDrawable);
            mMsgTv.setTextSize(style.getReceiveBubbleTextColor());
            mMsgTv.setBackground(style.getSendBubbleDrawable());
            mMsgTv.setPadding(style.getReceiveBubblePaddingLeft(), style.getReceiveBubblePaddingTop() + 3,
                    style.getReceiveBubblePaddingRight(), style.getReceiveBubblePaddingBottom() + 3);
