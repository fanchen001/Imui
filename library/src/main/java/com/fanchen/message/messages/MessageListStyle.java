...
import com.fanchen.message.commons.Style;
...
public class MessageListStyle extends Style {
    ...
    public static MessageListStyle parse(Context context, AttributeSet attrs) {
        ...
        style.datePaddingLeft = typedArray.getDimensionPixelSize(R.styleable.MessageListView_datePaddingLeft,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_padding_left_date_text));
        style.datePaddingTop = typedArray.getDimensionPixelSize(R.styleable.MessageListView_datePaddingTop,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_padding_top_date_text));
        style.datePaddingRight = typedArray.getDimensionPixelSize(R.styleable.MessageListView_datePaddingRight,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_padding_right_date_text));
        style.datePaddingBottom = typedArray.getDimensionPixelSize(R.styleable.MessageListView_datePaddingBottom,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_padding_bottom_date_text));
        style.dateBgColor = typedArray.getColor(R.styleable.MessageListView_dateBackgroundColor,
                ContextCompat.getColor(context, R.color.aurora_msg_date_bg_color));
        style.dateBgCornerRadius = typedArray.getDimensionPixelSize(R.styleable.MessageListView_dateCornerRadius,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_size_date_bg_radius));
        int eventTextSizePixel = typedArray.getDimensionPixelSize(R.styleable.MessageListView_eventTextSize,
        ...
        style.eventPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.MessageListView_eventPaddingLeft,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_padding_event_text));
        style.eventPaddingTop = typedArray.getDimensionPixelSize(R.styleable.MessageListView_eventPaddingTop,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_padding_event_text));
        style.eventPaddingRight = typedArray.getDimensionPixelSize(R.styleable.MessageListView_eventPaddingRight,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_padding_event_text));
        style.eventPaddingBottom = typedArray.getDimensionPixelSize(R.styleable.MessageListView_eventPaddingBottom,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_padding_event_text));
        style.eventTextColor = typedArray.getColor(R.styleable.MessageListView_eventTextColor,
                ContextCompat.getColor(context, R.color.aurora_msg_event_text_color));
        style.eventBgCornerRadius = typedArray.getDimensionPixelSize(R.styleable.MessageListView_eventCornerRadius,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_event_bg_corner_radius));
        style.eventBgColor = typedArray.getColor(R.styleable.MessageListView_eventBackgroundColor,
                ContextCompat.getColor(context, R.color.aurora_event_msg_bg_color));
        style.dateFormat = typedArray.getString(R.styleable.MessageListView_dateFormat);

        style.avatarWidth = typedArray.getDimensionPixelSize(R.styleable.MessageListView_avatarWidth,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_width_msg_avatar));
        style.avatarHeight = typedArray.getDimensionPixelSize(R.styleable.MessageListView_avatarHeight,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_height_msg_avatar));
        style.avatarRadius = typedArray.getDimensionPixelSize(R.styleable.MessageListView_avatarRadius,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_radius_avatar_default));
        style.showSenderDisplayName = typedArray.getBoolean(R.styleable.MessageListView_showSenderDisplayName, false);
        style.showReceiverDisplayName = typedArray.getBoolean(R.styleable.MessageListView_showReceiverDisplayName, false);
        int displayNameTextSize = typedArray.getDimensionPixelSize(R.styleable.MessageListView_displayNameTextSize,
        ...
        style.displayNameTextColor = typedArray.getColor(R.styleable.MessageListView_displayNameTextColor,
                ContextCompat.getColor(context, R.color.aurora_display_name_text_color));
        style.receiveBubbleDrawable = typedArray.getResourceId(R.styleable.MessageListView_receiveBubbleDrawable, -1);
        style.receiveBubbleColor = typedArray.getColor(R.styleable.MessageListView_receiveBubbleColor,
                ContextCompat.getColor(context, R.color.aurora_msg_receive_bubble_default_color));
        style.receiveBubblePressedColor = typedArray.getColor(R.styleable.MessageListView_receiveBubblePressedColor,
                ContextCompat.getColor(context, R.color.aurora_msg_receive_bubble_pressed_color));
        style.receiveBubbleSelectedColor = typedArray.getColor(R.styleable.MessageListView_receiveBubbleSelectedColor,
                ContextCompat.getColor(context, R.color.aurora_msg_receive_bubble_selected_color));
        int receiveTextSizePixel = typedArray.getDimensionPixelSize(R.styleable.MessageListView_receiveTextSize,
        ...
        style.receiveBubbleTextColor = typedArray.getColor(R.styleable.MessageListView_receiveTextColor,
        ...
        style.receiveBubblePaddingLeft = typedArray.getDimensionPixelSize(
                R.styleable.MessageListView_receiveBubblePaddingLeft,
        ...
        style.receiveBubblePaddingTop = typedArray.getDimensionPixelSize(
                R.styleable.MessageListView_receiveBubblePaddingTop,
        ...
        style.receiveBubblePaddingRight = typedArray.getDimensionPixelSize(
                R.styleable.MessageListView_receiveBubblePaddingRight,
        ...
        style.receiveBubblePaddingBottom = typedArray.getDimensionPixelSize(
                R.styleable.MessageListView_receiveBubblePaddingBottom,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_padding_receive_text_bottom));

        style.sendBubbleDrawable = typedArray.getResourceId(R.styleable.MessageListView_sendBubbleDrawable, -1);
        style.sendBubbleColor = typedArray.getColor(R.styleable.MessageListView_sendBubbleColor,
                ContextCompat.getColor(context, R.color.aurora_msg_send_bubble_default_color));
        style.sendBubblePressedColor = typedArray.getColor(R.styleable.MessageListView_sendBubblePressedColor,
                ContextCompat.getColor(context, R.color.aurora_msg_send_bubble_pressed_color));
        style.sendBubbleSelectedColor = typedArray.getColor(R.styleable.MessageListView_sendBubbleSelectedColor,
                ContextCompat.getColor(context, R.color.aurora_msg_send_bubble_selected_color));
        int sendTextSizePixel = typedArray.getDimensionPixelSize(R.styleable.MessageListView_sendTextSize,
        ...
        style.sendBubbleTextColor = typedArray.getColor(R.styleable.MessageListView_sendTextColor,
                ContextCompat.getColor(context, R.color.aurora_msg_send_text_color));
        style.sendBubblePaddingLeft = typedArray.getDimensionPixelSize(R.styleable.MessageListView_sendBubblePaddingLeft,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_padding_send_text_left));
        style.sendBubblePaddingTop = typedArray.getDimensionPixelSize(R.styleable.MessageListView_sendBubblePaddingTop,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_padding_send_text_top));
        style.sendBubblePaddingRight = typedArray.getDimensionPixelSize(R.styleable.MessageListView_sendBubblePaddingRight,
        ...
        style.sendBubblePaddingBottom = typedArray.getDimensionPixelSize(
                R.styleable.MessageListView_sendBubblePaddingBottom,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_padding_send_text_bottom));
        style.lineSpacingExtra = typedArray.getDimensionPixelSize(R.styleable.MessageListView_lineSpacingExtra,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_line_spacing_extra_default));
        style.lineSpacingMultiplier = typedArray.getFloat(R.styleable.MessageListView_lineSpacingMultiplier, 1.0f);
        style.sendVoiceDrawable = typedArray.getResourceId(R.styleable.MessageListView_sendVoiceDrawable,
                R.drawable.aurora_sendvoice_send_3);
        style.receiveVoiceDrawable = typedArray.getResourceId(R.styleable.MessageListView_receiveVoiceDrawable,
                R.drawable.aurora_receivevoice_receive_3);
        style.playSendVoiceAnim = typedArray.getResourceId(R.styleable.MessageListView_playSendVoiceAnim,
                R.drawable.aurora_anim_send_voice);
        style.playReceiveVoiceAnim = typedArray.getResourceId(R.styleable.MessageListView_playReceiveVoiceAnim,
                R.drawable.aurora_anim_receive_voice);

        WindowManager wm = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
        style.bubbleMaxWidth = typedArray.getFloat(R.styleable.MessageListView_bubbleMaxWidth, 0.8f);
        style.windowWidth = wm.getDefaultDisplay().getWidth();

        style.sendPhotoMsgBg = typedArray.getDrawable(R.styleable.MessageListView_sendPhotoMsgBg);
        style.receivePhotoMsgBg = typedArray.getDrawable(R.styleable.MessageListView_receivePhotoMsgBg);
        style.videoDurationTextColor = typedArray.getColor(R.styleable.MessageListView_videoDurationTextColor,
                ContextCompat.getColor(context, R.color.aurora_video_message_duration_text_color));
        int videoDurationTextSize = typedArray.getDimensionPixelSize(R.styleable.MessageListView_videoDurationTextSize,
        ...
        style.photoMessageRadius = typedArray.getDimensionPixelSize(R.styleable.MessageListView_photoMessageRadius,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_radius_photo_message));
        style.videoMessageRadius = typedArray.getDimensionPixelSize(R.styleable.MessageListView_videoMessageRadius,
                context.getResources().getDimensionPixelSize(R.dimen.aurora_radius_video_message));
        style.sendingProgressDrawable = typedArray.getDrawable(R.styleable.MessageListView_sendingProgressDrawable);
        style.sendingIndeterminateDrawable = typedArray
                .getDrawable(R.styleable.MessageListView_sendingIndeterminateDrawable);
        typedArray.recycle();
        return style;
    }
