...
public class RoundImageView extends BaseImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.MessageListView);
        mRadius = array.getDimensionPixelSize(R.styleable.MessageListView_avatarRadius,
