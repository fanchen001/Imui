...
import com.fanchen.guide.bean.Confirm;
import com.fanchen.guide.bean.HighlightArea;
import com.fanchen.guide.bean.Message;
...
public class EasyGuide {
    ...
    public EasyGuide(Activity activity) {
        this(activity, 1,null, null, null, null, true, false);
    }

    public EasyGuide(Activity activity, int showCount,List<HighlightArea> areas, List<TipsView> indicators,
    ...
    public void show() {
            ...
            if (mAreas != null) {
                for (HighlightArea a : mAreas) {
                    if (a.mHightlightView != null) {
                        keyBuilder.append(a.mHightlightView.getClass().getSimpleName());
                        keyBuilder.append("_");
                        keyBuilder.append(a.mHightlightView.getWidth());
                        keyBuilder.append("_");
                        keyBuilder.append(a.mHightlightView.getHeight());
                    }
                }
            }
        ...
        if (mConfirm != null) {
            ...
            tvConfirm.setBackgroundResource(R.drawable.btn_guide_selector);
    ...
    public static class Builder {
        ...
        public EasyGuide build() {
            return new EasyGuide(activity,count, areas, views, messages, confirm, dismissAnyWhere, performViewClick);
        }
    }
