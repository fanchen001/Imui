...
import com.fanchen.zxing.camera.CameraManager;
import com.fanchen.zxing.manager.BeepManager;
import com.fanchen.zxing.manager.InactivityTimer;
import com.fanchen.zxing.model.MNScanConfig;
import com.fanchen.zxing.other.MNCustomViewBindCallback;
import com.fanchen.zxing.utils.CommonUtils;
import com.fanchen.zxing.utils.ImageUtils;
import com.fanchen.zxing.utils.ZXingUtils;
import com.fanchen.zxing.view.VerticalSeekBar;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_z_scan_capture);
    ...
    private void openLight() {
        if (!is_light_on) {
            ...
            iv_scan_light.setImageResource(R.drawable.z_icon_scan_flash_light_on);
    ...
    private void closeLight() {
        if (is_light_on) {
            ...
            iv_scan_light.setImageResource(R.drawable.z_icon_scan_flash_light_off);
    ...
    private void initIntent() {
        ...
        if (exitAnime == 0) {
            exitAnime = R.anim.z_scan_activity_bottom_out;
        }
    ...
    public void restartPreviewAfterDelay(long delayMS) {
        if (handler != null) {
            handler.sendEmptyMessageDelayed(R.id.z_restart_preview, delayMS);
        }
        resetStatusView();
    }
