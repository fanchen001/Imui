package com.fanchen.zxing.utils;
...
public class MProgressWheel extends View {
  ...
  public MProgressWheel(Context context, AttributeSet attrs) {
    ...
    parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.ZScanProgressWheel));
  ...
  private void parseAttributes(TypedArray a) {
    ...
    circleRadius =
        (int) a.getDimension(R.styleable.ZScanProgressWheel_mn_circleRadius, circleRadius);

    fillRadius = a.getBoolean(R.styleable.ZScanProgressWheel_mn_fillRadius, false);

    barWidth = (int) a.getDimension(R.styleable.ZScanProgressWheel_mn_barWidth, barWidth);

    rimWidth = (int) a.getDimension(R.styleable.ZScanProgressWheel_mn_rimWidth, rimWidth);

    float baseSpinSpeed =
        a.getFloat(R.styleable.ZScanProgressWheel_mn_spinSpeed, spinSpeed / 360.0f);
    spinSpeed = baseSpinSpeed * 360;

    barSpinCycleTime =
        a.getInt(R.styleable.ZScanProgressWheel_mn_barSpinCycleTime, (int) barSpinCycleTime);

    barColor = a.getColor(R.styleable.ZScanProgressWheel_mn_barColor, barColor);

    rimColor = a.getColor(R.styleable.ZScanProgressWheel_mn_rimColor, rimColor);

    linearProgress = a.getBoolean(R.styleable.ZScanProgressWheel_mn_linearProgress, false);

    if (a.getBoolean(R.styleable.ZScanProgressWheel_mn_progressIndeterminate, false)) {
      spin();
    }
